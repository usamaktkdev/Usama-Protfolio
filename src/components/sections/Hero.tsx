...
export default function Hero() {
  ...
  return (
    <section className="mb-8 md:mb-xl relative">
      ...
      >
        ...
        <motion.h1 variants={itemVariants} className="font-display-xl text-3xl md:text-display-xl font-black tracking-tighter antialiased text-on-surface mb-md">
